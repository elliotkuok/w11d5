...
export const editPokemon = (pokeID) => async dispatch => {
  ...
  if (response.ok){
    ...
    return dispatch(addOnePokemon(updatedPokemon));
    }
    else {
    console.log('WARNING!')
  }
...
export const createPokemon = (pokeForm) => async dispatch => {
  ...
  if (response.ok){
    ...
    return dispatch(addOnePokemon(newPokemon));
    }
   else {
    console.log('WARNING!')
  }
...
export const getPokemonDetails = (id) => async dispatch => {
  ...
  return await dispatch(addOnePokemon(data))
}
